...
void main() {
  ...
  testWidgets('HtmlDiv AutoSize width (Block behavior)', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('HtmlDiv AutoSize height (Content wrapping)', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('HtmlDiv nested layout (Vertical stacking)', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('HtmlDiv minWidth clamps used width', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
    ...
    expect(renderBox.size.width, 120);
  });

  testWidgets('HtmlDiv maxWidth clamps used width', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('HtmlDiv minHeight/maxHeight clamp used height', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('HtmlDiv minWidth respects contentBox + border', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
    ...
    // contentBox: minWidth applies to content width. Border adds 20.
    final RenderBox renderBox = tester.renderObject(find.byType(HtmlDiv));
    expect(renderBox.size.width, 120);
  });
}
